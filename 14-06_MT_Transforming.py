...
# #Removing products that are bought 1000 times or less. Reduction from 32434489 to 26498548
# #We go from 49677 products to 5053 products
# data = data.groupby('product_id').filter(lambda x: x.shape[0]>1000)
...
#Total amount of orders per user
...
data.to_csv("data_small_transformed.csv", index = False)
